task(
  ...
  .setAction(async (taskArgs) => {
    ...
    const Metamaticians = await ethers.getContractFactory("Metamaticians");
    ...
    const vrfConsumerContract = new ethers.Contract(
      contractAddr,
      Metamaticians.interface,
      signer
    );
    const result = BigInt(await vrfConsumerContract.randomResult()).toString();
